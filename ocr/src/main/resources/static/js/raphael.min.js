    ...
    return function (t) {
        ...
        i = [r(3)], void 0 === (n = function (t) {
            ...
            var r, i, n = /[, ]+/, a = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, s = /\{(\d+)\}/g,
                ...
                p = "ontouchstart" in l.win || l.win.DocumentTouch && l.doc instanceof DocumentTouch, d = "", g = " ",
                x = String, v = "split",
                ...
                _ = Math, w = _.max, k = _.min, B = _.abs, C = _.pow, S = _.PI, A = "number", T = "array",
                ...
                H = function (t, e) {
                    ...
                    if (!e) return t;
                    var r, i, n, a, s, o, l;
                    for (n = 0, s = (t = At(t)).length; n < s; n++) for (a = 1, o = (l = t[n]).length; a < o; a += 2) r = e.x(l[a], l[a + 1]), i = e.y(l[a], l[a + 1]), l[a] = r, l[a + 1] = i;
                    return t
                };
            ...
            var yt = e.pathBBox = function (t) {
                ...
                for (var r, i = 0, n = 0, a = [], s = [], o = 0, l = (t = At(t)).length; o < l; o++) if ("M" == (r = t[o])[0]) i = r[1], n = r[2], a.push(i), s.push(n); else {
                ...
                if (e.is(t, T) && e.is(t && t[0], T) || (t = e.parsePathString(t)), !t || !t.length) return [["M", 0, 0]];
                var i = [], n = 0, a = 0, s = 0, o = 0, l = 0;
                ...
                if (h) T = h[0], M = h[1], C = h[2], A = h[3]; else {
                    ...
                    var b = r * r, w = i * i,
                        ...
                        C = k * r * y / i + (t + o) / 2, A = k * -i * x / r + (e + l) / 2,
                        T = _.asin(((e - A) / i).toFixed(9)), M = _.asin(((l - A) / i).toFixed(9));
                ...
                E = M - T;
                var z = _.cos(T), F = _.sin(T), R = _.cos(M), j = _.sin(M), I = _.tan(E / 4), D = 4 / 3 * r * I,
                    q = 4 / 3 * i * I, O = [t, e], V = [t + D * F, e - q * z], Y = [o + D * j, l - q * R], W = [o, l];
            ...
            }, null, mt), Tt = (e._parseDots = ht(function (t) {
                    ...
                    if (c) c.initstatus = s, c.start = new Date - c.ms * s; else {
                        for (var S in u) if (u[o](S) && (I[o](S) || i.paper.customAttributes[o](S))) switch (b[S] = i.attr(S), null == b[S] && (b[S] = j[S]), _[S] = u[S], I[S]) {
                            ...
                            case"colour":
                                b[S] = e.getRGB(b[S]);
                                var T = e.getRGB(_[S]);
                                w[S] = {r: (T.r - b[S].r) / m, g: (T.g - b[S].g) / m, b: (T.b - b[S].b) / m};
                                break;
                            case"path":
                                var M = At(b[S], _[S]), E = M[1];
                        ...
                        var Y = u.easing, W = e.easing_formulas[Y];
                        if (!W) if ((W = x(Y).match(L)) && 5 == W.length) {
                            var G = W;
                            W = function (t) {
            ...
            var oe, le, he = function (t) {
                if (this.items = [], this.length = 0, this.type = "set", t) for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != Yt.constructor && t[e].constructor != he || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
            }, ue = he.prototype;
            ...
            return ue.attr = function (t, r) {
                if (t && e.is(t, T) && e.is(t[0], "object")) for (var i = 0, n = t.length; i < n; i++) this.items[i].attr(t[i]); else for (var a = 0, s = this.items.length; a < s; a++) this.items[a].attr(t, r);
                return this
            }, ue.clear = function () {
                ...
                if (e.is(a, "string") && (a = this.getFont(a)), a) {
                    ...
                    for (var y = a.face.bbox[v](n), m = +y[0], b = y[3] - y[1], _ = 0, B = +y[1] + ("baseline" == o ? b + +a.face.descent : b / 2), C = 0, S = c.length; C < S; C++) {
                        if ("\n" == c[C]) f = 0, T = 0, p = 0, _ += b * h; else {
                            var A = p && a.glyphs[c[C - 1]] || {}, T = a.glyphs[c[C]];
            ...
            if (!t || t.vml) {
                ...
                var k, B = function (t, e, i) {
                    ...
                    if ("text" == A.type) {
                        ...
                        var H = A.paper.span, X = g.font && g.font.match(/\d+(?:\.\d*)?(?=px)/);
        ...
        i = [r(0)], void 0 === (n = function (t) {
            if (!t || t.svg) {
                ...
                var x = function (i, n) {
                    ...
                    if ("path" == i.type) {
                        ...
                        if ("open" == w ? (k += 2, B += 2, C += 2, l = 1, h = a ? 4 : 1, u = {
                            ...
                            var S = "raphael-marker-" + w, A = "raphael-marker-" + v + w + k + B + "-obj" + i.id;
                        ...
                        switch (u[d] = g, d) {
                            ...
                            case"clip-rect":
                                ...
                                if (4 == S.length) {
                                    ...
                                    var A = x("clipPath"), T = x("rect");
                                    A.id = t.createUUID(), x(T, {
                                        x: S[0],
                                        y: S[1],
                                        width: S[2],
                                        height: S[3]
                                    }), A.appendChild(T), i.paper.defs.appendChild(A), x(l, {"clip-path": "url(#" + A.id + ")"}), i.clip = T
                                }
                                if (!g) {
                            ...
                            case"fill":
                                ...
                                if (N) {
                                    ...
                                    A.id = t.createUUID(), x(A, {
                                        ...
                                        height: 1,
                                        width: 1
                                    }), x(L, {x: 0, y: 0, "xlink:href": N[1]}), A.appendChild(L), function (e) {
                                        t._preload(N[1], function () {
                                            var t = this.offsetWidth, r = this.offsetHeight;
                                            x(e, {width: t, height: r}), x(L, {width: t, height: r})
                                        })
                                    }(A), i.paper.defs.appendChild(A), x(l, {fill: "url(#" + A.id + ")"}), i.pattern = A, i.pattern && m(i);
                                    break
                                }
                                var P = t.getRGB(g);
                                if (P.error) {
                ...
                S.prototype = A, A.constructor = S, t._engine.path = function (t, e) {
                    ...
                    }), 1 == r ? (l.style.cssText = h + "position:absolute;left:" + i + "px;top:" + n + "px", t._g.doc.body.appendChild(l), o = 1) : (l.style.cssText = h + "position:relative", r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l)), (r = new t._Paper).width = a, r.height = s, r.canvas = l, r.clear(), r._left = r._top = 0, o && (r.renderfix = function () {
                    }), r.renderfix(), r
